package com.core.lion.config.resolver;

import com.core.lion.config.CoreException;
import com.core.lion.enums.ErrorCodeEnum;
import com.core.lion.service.core.ApiTokenService;
import com.core.lion.util.Utility;
...
public class ApiTokenResolver {
    ...
    @Pointcut(value = "@annotation(com.core.lion.config.ApiTokenValidator)")
